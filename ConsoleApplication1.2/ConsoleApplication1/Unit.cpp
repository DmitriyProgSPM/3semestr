...
void Unit::operator+(Kit& kit)
{
	health += 10;
}

void Unit::operator+(Armory& armory)
{
	power += 10;
}

void Unit::operator+(Trap& trap)
{
	health -= 10;
	armor -= 10;
}

void Unit::operator+(Warehouse& warehouse)
{
	armor += 10;
}

void Unit::operator+(Unit& unit)
{
